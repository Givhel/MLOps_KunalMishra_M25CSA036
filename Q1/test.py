...
def test(model_path, use_lora=False, rank=4, alpha=4, dropout=0.1):
    ...
    wandb.init(project="DLops-Assignment-5", name="test_results_best_model")
    wandb.log({"overall_test_accuracy": overall_acc, "classwise_histogram": wandb.Image("classwise_accuracy.png")})
    wandb.finish()
